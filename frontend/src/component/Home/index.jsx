...
export const Home = () => {
  ...
  return (
    <Fragment>
      {!loading ? (
        <div className="app-loading-div"><VscSync /> &nbsp;Loading, Please wait....</div>
      ) : (
      ...
      {showAdd && <Add getFetchItem={getFetchItem} handleClose={handleClose} />}
      {editShow && <Edit editItem={editItem} getFetchItem={getFetchItem} handleClose={handleClose} />}
      {delShow && <Delete delItem={delItem} deleteItem={deleteItem} handleClose={handleClose} />}
    </Fragment>
  )
}
